        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <span class="badge bg-{{ $student->user->is_active ? 'success' : 'danger' }} mb-3">
                    ...
                    <div class="text-end mt-3">
                        ...
                        <a href="{{ route('dashboard.students.edit', $student->nisn) }}" class="btn btn-warning btn-sm">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table table-borderless table-sm">
                                ...
                                <tr>
                                    <th>Tanggal Lahir</th>
                                    <td>: {{ $student->date_of_birth ? $student->date_of_birth->format('d F Y') : '-' }}
                                    </td>
                                </tr>
                                <tr>
                                    <th>Umur</th>
